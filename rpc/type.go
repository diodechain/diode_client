...
var GetBlockPeakType = []byte("getblockpeak")
var GetBlockHeaderType = []byte("getblockheader")
...
var BlockPeakChan = make(chan int)
var BlockHeaderChan = make(chan *BlockHeader)
